...
export class MemberSidebarComponent {
  ...
  navItems = [
    ...
    { label: 'Workouts', icon: 'calendar', route: '/member/workouts' },
    { label: 'Exercises', icon: 'fitness', route: '/exercises' },
    
    { label: 'Health', isHeader: true },
    { label: 'Nutrition', icon: 'food', route: '/nutrition' },
    { label: 'Progress', icon: 'dashboard', route: '/member/progress' },
    
    { label: 'Community', isHeader: true },
    { label: 'Group Classes', icon: 'users', route: '/community/classes' },
    { label: 'Forum', icon: 'users', route: '/community/forum' },

    { label: 'Settings', isHeader: true },
    { label: 'Profile', icon: 'settings', route: '/settings/profile' },
